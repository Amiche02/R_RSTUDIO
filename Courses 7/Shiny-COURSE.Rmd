...
ui <- fluidPage(
  titlePanel("Sleeping habits in America"), 
  checkboxInput("checkboxlabel", "Display year", value = TRUE),
...
server <- function(input, output, session) {
  # Vous pouvez ajouter ici le code de traitement ou de réactivité
  # en fonction des éléments d'entrée de l'utilisateur (input)
}
